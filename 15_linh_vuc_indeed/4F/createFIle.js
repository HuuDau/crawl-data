...
const crawData = async (payload) => {
  try {
    ...
    await page.type('#user_email', 'anhndbk@gmail.com');
    await page.type('#user_password', 'Ducanh@123123');
...
//     await page.goto('https://itviec.com/viec-lam-it/senior-full-stack-developer-drupal-wordpress-javac-technology-software-company-ltd-5838?lab_feature=preview_jd_page');
...
// };
  // crawData1({
  //   link:'https://itviec.com/viec-lam-it/expert-developer?job_selected=expert-wordpress-developer-employment-hero-1032',
  //   fileName:'Expert Developer.json'
  // })
