...
const getListFileName = async () => {
  try {
    ...
    return files.filter(name => name !== '3c.json' && name !== 'createFIle.js' && name !== 'index.js'); 
  } catch (err) {
    throw err; 
  }
}
